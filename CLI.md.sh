...
generate() {
    ...
    command "Token.RegisterMetaDcdt" "token register-meta-dcdt"
    ...
    command "Token.SetSpecialRoleMetaDcdt" "token set-special-role-meta-dcdt"
    command "Token.UnsetSpecialRoleMetaDcdt" "token unset-special-role-meta-dcdt"
    ...
    command "Token.ChangeSftToMetaDcdt" "token change-sft-to-meta-dcdt"
