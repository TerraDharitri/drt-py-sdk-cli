...
user_address = "drt1cqqxak4wun7508e0yj9ng843r6hv4mzd0hhpjpsejkpn9wa9yq8s0ztfl2"
grace = "drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8"
frank = "drt1kdl46yctawygtwg2k462307dmz2v55c605737dp3zkxh04sct7asacg58j"
...
def test_register_meta_dcdt(capsys: Any):
    return_code = main(
        [
            "token",
            "register-meta-dcdt",
...
def test_create_nft(capsys: Any):
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTNFTCreate@4652414e4b2d616139653864@01@74657374@03e8@61626261@74657374@61@62"
...
def test_set_special_roles_on_meta_dcdt(capsys: Any):
    return_code = main(
        [
            "token",
...
def test_unset_special_roles_on_meta_dcdt(capsys: Any):
    return_code = main(
        [
            "token",
...
def test_local_mint(capsys: Any):
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTLocalMint@4652414e4b2d313163653365@0a"
...
def test_local_burn(capsys: Any):
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTLocalBurn@4652414e4b2d313163653365@0a"
...
def test_update_attributes(capsys: Any):
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTNFTUpdateAttributes@4652414e4b2d313163653365@0a@74657374"
...
def test_add_quantity(capsys: Any):
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTNFTAddQuantity@4652414e4b2d313163653365@0a@0a"
...
def test_burn_quantity(capsys: Any):
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTNFTBurn@4652414e4b2d313163653365@0a@0a"
...
def test_modify_royalties(capsys: Any):
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTModifyRoyalties@544553542d313233343536@01@04d2"
...
def test_set_new_uris(capsys: Any):
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTSetNewURIs@544553542d313233343536@01@6669727374555249@7365636f6e64555249"
...
def test_modify_creator(capsys: Any):
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTModifyCreator@544553542d313233343536@01"
...
def test_register_dynamic_meta_dcdt(capsys: Any):
    return_code = main(
        [
            "token",
            "register-dynamic",
...
def test_register_dynamic_and_set_all_roles_meta_dcdt(capsys: Any):
    return_code = main(
        [
            "token",
            "register-dynamic-and-set-all-roles",
...
def test_change_sft_to_meta_dcdt(capsys: Any):
    return_code = main(
        [
            "token",
    ...
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "changeSFTToMetaDCDT@5346542d313233343536@06"
...
def test_add_uris(capsys: Any):
    ...
    transaction = get_transaction(capsys)
    assert transaction["sender"] == user_address
    assert transaction["receiver"] == "drt1cqqxak4wun7508e0yj9ng843r6hv4mzd0hhpjpsejkpn9wa9yq8s0ztfl2"
    assert transaction["value"] == "0"
    assert transaction["chainID"] == "D"
    data = base64.b64decode(transaction["data"]).decode()
    assert data == "DCDTNFTAddURI@5346542d313233343536@0a@6669727374555249@7365636f6e64555249"
