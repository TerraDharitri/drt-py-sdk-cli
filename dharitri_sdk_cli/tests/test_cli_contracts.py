...
def test_contract_upgrade():
    ...
    contract_address = "drt1qqqqqqqqqqqqqpgq5l9jl0j0gnqmm7hn82zaydwux3s5xuwkyq8s7hr0n6"
...
def test_contract_transfer_and_execute(capsys: Any):
    contract_address = "drt1qqqqqqqqqqqqqpgqv7sl6ws5dgwe5m04xtg0dvqyu2efz5a6d8ssm0z4x7"
...
def test_contract_call_with_abi(capsys: Any):
    ...
    return_code = main(
        [
            "contract",
            "call",
            "drt1qqqqqqqqqqqqqpgqpg2tnjelx3s3dhkksqhjavprtgmt9xt4d8sscpgyct",
            "--pem",
            alice,
            "--chain",
            "T",
